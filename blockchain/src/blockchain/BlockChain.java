...
public class BlockChain {
	...
	static final String[]  sIPPreArray={"192.168.1.125","192.168.1.117","192.168.1.41","192.168.1.37","192.168.1.85","172.16.1.127","172.16.1.117","192.168.1.53"};                 //�Ծ������ڵĵ��Խ���ɨ�裬�ҵ�����������ص�����
...
//		for(int i=100;i<130;i+=1){
		for(int i=0;i<sIPPreArray.length;i++){
//			String sThisURL="http://"+sIPPre+i+":8080/blockchain/chain.jsp";
			String sThisURL="http://"+sIPPreArray[i]+":8080/blockchain/chain.jsp";
